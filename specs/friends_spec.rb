...
def test_do_they_like_this_food
  result = do_they_like_this_food(@person1, "toast")
  assert_equal(false, result)
end

def test_do_they_like_this_food__2
  result = do_they_like_this_food(@person2, "bread")
...
def test_add_new_friend
  add_new_friend(@person3, "Scrappy-Doo")
  ...
  def test_fall_out_with_friend
    fall_out_with_friend(@person3, "Scrappy-Doo")
...
assert_equal(143, result)
 ...
 result = lending_money(@person4, @person1, 5)
 assert_equal(@person4[:monies], 15)
